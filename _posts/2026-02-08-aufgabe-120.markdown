...
$$
3^{-1} \equiv 333333336 \pmod{10^9 + 7 }
$$
...
Der entsprechende Code für e = 2 wäre dann einfach (nur mit g++ möglich wegen __int128): 
...
Das Interessante an dieser Aufgabe ist natürlich der Fall e = 3. Hier bleibt einem zunächst nichts anderes übrig als einfach mal auf Papier loszurechnen. Meine Tips lauten:
...
2. Berechne \\( R(3, 3) = 24 \\) und \\( R(4, 3) = 56 \\) von Hand, indem einfach mal alle n von 0 bis \\( a^3 \\) eingesetzt werden. So entwickelt man auch ein Gefühl für die periodische Dynamik, die hier mit im Spiel ist. 
...
Codeauszug mit entsprechenden Auslassungen: 
...
[forum]: https://projecteuler.net/thread=120
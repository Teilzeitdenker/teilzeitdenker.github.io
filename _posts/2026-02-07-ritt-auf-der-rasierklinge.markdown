...
Auch das [Projekt Euler+][project-euler-plus] auf [HackerRank][hacker-rank] wird sich dieser Entwicklung binnen absehbarer Zeit wohl nicht mehr entziehen können, aber bis heute gibt es erstaunlich wenig dazu zu finden, was den Wert jeder eigenen Lösung erheblich steigert (schon klar, dass es jedem selbst überlassen ist, ob er "Lösungen nachschaut" und damit das eigene Lernerlebnis torpediert, aber leider ist es ja so, dass vernünftige Menschen mit effizient arbeitenden Gehirnen dazu neigen, sich die Arbeit grundsätzlich erleichtern zu wollen, auch wenn das auf lange Sicht den Niedergang ihrer eigentlichen Intelligenz und damit den Untergang des Abendlandes verursachen mag). Bis es also binnen der nächsten zwei Jahre auch mit dieser letzten ultimativen HackerRank-Challenge soweit kommt, will ich versuchen, wie ein Verdurstender noch die letzten köstlichen Tropfen Erkenntnisgewinn-Nektars herauszupressen. Dieser "Blog" soll eine Art Tagebuch dieses meines Vorhabens und Fortschritts ab etwa Aufgabe 120 werden. 

Der im Titel genannte "Ritt auf der Rasierklinge" besteht nun darin, hier nicht einfach ganz öde die alles verratenden Lösungen zu posten, die ja dem geneigten (und hilflos ausgelieferten) Leser (ein seltsam satanisches Grinsen umspielt hierbei die Lippen des Autors) den eben gerade in großen Tönen gelobten Spaß am Selbstversuch vergällen würden. Vielmehr sollen zielgerichtete kleine Hinweise gegeben werden, die eventuelles Ungemach abwenden können. Denn nicht jeder scheitert mit Würde oder verfügt über die nötige Resilienz, um seinen aufgestauten Frust durch das stetige Rennen gegen geziegelte Mauern aus Wrong Answers und TLEs nicht irgendwann an der klapprigen Tastatur oder unschuldig herumstehenden Möbeln/Haustieren auslassen zu wollen. In diesem Sinne sieht sich diese Seite auch der medizinischen Wutanfalls-Prävention und dem Tierschutz verpflichtet. 
